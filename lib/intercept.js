 ...
 */
export function installThinkingModeIntercept(ctx, { getMode, getSampling, getEffort, config, log }) {
  ...
  async function* directStream(options, target, mode, attachments) {
    ...
    try {
      ...
      const body = buildBody(options, thinkingOn, wireMessages, { sampling, effort });
